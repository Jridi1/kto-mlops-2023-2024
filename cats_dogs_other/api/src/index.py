...
issuer = "https://dev-wd83dlmm35q11jb5.us.auth0.com/" # This is a value from an environment variable. It allows us to not hard code some information
audience = "https://abderrahim-cats-dogs.com" # this line is new
...
async def upload(file: UploadFile, token: str = Depends(oauth2_scheme)): # Take a look at this new token argument
    if not skip_oidc:
        await authentication.validate_async(token, audience, "get::prediciton") # This function will validate the token
